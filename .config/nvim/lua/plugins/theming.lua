return {
  -- Base16 and base24 colors (https://github.com/tinted-theming/tinted-nvim)
  {
    "tinted-theming/tinted-nvim",
    -- TODO: I don't quite like the coloring here compared to tinted-vim
    enabled = false,
    ...
    config = function()
      ...
      -- Load the colorscheme dynamically based on `tinty current`
      tinted.setup(nil, {
        supports = {
          live_reload = true,
        },
  ...
  -- Base16 and base24 colors (https://github.com/tinted-theming/tinted-vim)
  {
